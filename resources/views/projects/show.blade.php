            ...
            <div class="d-flex justify-content-between align-items-center">
                ...
                @auth
                    ...
                    <div class="btn-group btn-group-sm">
                        ...
                        <a class="btn btn-danger" href="#" onclick="document.getElementById('delete_project').submit()">Eliminar</a>
                    </div>
                    
                    <form class="d-none" id="delete_project" method="POST" action="{{ route('projects.destroy', $project) }}">
                        @csrf @method('DELETE')
                    </form>
                @endauth
            </div>
